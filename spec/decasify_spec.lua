...
describe("decasify", function()
   ...
   describe("lowercase", function()
      ...
      it("should not balk at nil values for optional args", function()
         assert.no.error(function () lowercase("foo", "en") end)
         assert.no.error(function () lowercase("foo") end)
      end)
   ...
   describe("uppercase", function()
      ...
      it("should not balk at nil values for optional args", function()
         assert.no.error(function () uppercase("foo", "en") end)
         assert.no.error(function () uppercase("foo") end)
      end)
